...
ALIVE_NAME = getenv("ALIVE_NAME", "ELLIOT")
BOT_USERNAME = getenv("BOT_USERNAME", "ELLIOT2_Robot")
OWNER_ID = getenv("OWNER_ID", "1669178360")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "ELLIOT2_Assistant")
...
START_PIC = getenv("START_PIC", "https://telegra.ph/file/3978f9bb008f255ea3280.jpg")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ZVMUSIC/ELLIOT-MUSIC")
