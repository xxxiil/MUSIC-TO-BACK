# Copyright (C) 2021 By ELLIOT Vc Player
...
from ELLIOT.decorators import humanbytes
...
async def song(_, message):
    ...
    try:
        ...
        m.edit("❌ لم يتم العثور علي اغنيه.\n\nplease give a valid song name.")
        print(str(e))
        return
    m.edit("📥 جاري تنزيل الملف...")
    try:
        ...
        m.edit("❌ خطأ, انتظر ليتم الاصلاح من المالك")
        print(e)
...
async def vsong(client, message):
    if HEROKU_MODE == "ENABLE":
        await m.reply_text("__يتم تمكين وضع Heroku حاليًا حتى لا يمكنك تنزيل الفيديو لأن بث الفيديو سبب حظر حساب Heroku الخاص بك__.")
        return
    ydl_opts = {
        "format": "best",
        "keepvideo": True,
    ...
    await msg.edit("📤 **جاري رفع الفديو...**")
