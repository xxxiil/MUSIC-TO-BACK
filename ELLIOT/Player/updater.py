...
from ELLIOT.filters import command
from ELLIOT.decorators import sudo_users_only
...
async def update_bot(_, message: Message):
    ...
    if update_avail:
        await msg.edit("✅ انتهي التحديث !\n\n• إعادة تشغيل البوت, نشط مره اخري بعد 1 دقيقه.")
...
async def restart_bot(_, message: Message):
    try:
        ...
        print(f"[ERROR]: {err}")
        return
    await msg.edit_text("✅ تم عمل ريستار !\n\n» سيفعل البوت خلال 5-10 ثواني.")
